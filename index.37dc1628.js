 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&m(t.buffer)},isString:y,isNumber:E,isBoolean:t=>!0===t||!1===t,isObject:w,isPlainObject:v,isUndefined:g,isDate:A,isFile:S,isBlob:C,isRegExp:N,isFunction:b,isStream:t=>w(t)&&b(t.pipe),isURLSearchParams:R,isTypedArray:U,isFileList:O,forEach:L,merge:/**
 ...
 *
 * @returns {boolean}
 */function(t){return!!(t&&b(t.append)&&"FormData"===t[Symbol.toStringTag]&&t[Symbol.iterator])},toJSONObject:t=>{let e=Array(10),r=(t,n)=>{if(w(t)){if(e.indexOf(t)>=0)return;if(!("toJSON"in t)){e[n]=t;let o=d(t)?[]:{};return L(t,(t,e)=>{let i=r(t,n+1);g(i)||(o[e]=i)}),e[n]=void 0,o}}return t};return r(t,0)},isAsyncFn:D,isThenable:t=>t&&(w(t)||b(t))&&b(t.then)&&b(t.catch)};/**
 ...
 **/Z.alloc=function(t,e,r){return(tt(t),t<=0)?X(t):void 0!==e?"string"==typeof r?X(t).fill(e,r):X(t).fill(e):X(t)},/**
 ...
 */function tS(t){return M.endsWith(t,"[]")?t.slice(0,-2):t}/**
 ...
 *
 * @returns {void}
 */function tT(t,e){this._pairs=[],t&&tR(t,this,e)}const tk=tT.prototype;/**
 ...
 */function tB(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function tU(t,e,r){let n;/*eslint no-param-reassign:0*/if(!e)return t;let o=r&&r.encode||tB,i=r&&r.serialize;if(n=i?i(e,r):M.isURLSearchParams(e)?e.toString():new tT(e,r).toString(o)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+n}return t}tk.append=function(t,e){this._pairs.push([t,e])},tk.toString=function(t){let e=t?function(e){return t.call(this,e,tL)}:tL;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var t_=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){M.forEach(this.handlers,function(e){null!==e&&t(e)})}},tx={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},tN="undefined"!=typeof URLSearchParams?URLSearchParams:tT,tj="undefined"!=typeof FormData?FormData:null,tP="undefined"!=typeof Blob?Blob:null;/**
...
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var tD={classes:{URLSearchParams:tN,FormData:tj,Blob:tP},isStandardBrowserEnv:tI,isStandardBrowserWebWorkerEnv:tF,protocols:["http","https","file","blob","url","data"]},tM=/**
...
t.data=tY.call(t,t.transformRequest),-1!==["post","put","patch"].indexOf(t.method)&&t.headers.setContentType("application/x-www-form-urlencoded",!1);let e=t9.getAdapter(t.adapter||tH.adapter);return e(t).then(function(e){return et(t),// Transform response data
...
eh.CanceledError=tZ,eh.CancelToken=ec,eh.isCancel=tX,eh.VERSION=eo,eh.toFormData=tR,// Expose AxiosError class
...
const{Axios:ep,AxiosError:ed,CanceledError:eg,isCancel:em,CancelToken:ey,VERSION:eb,all:eE,Cancel:ew,isAxiosError:ev,spread:eA,toFormData:eS,AxiosHeaders:eC,HttpStatusCode:eO,formToJSON:eR,getAdapter:eL,mergeConfig:eT}=eh;async function ek(t){let e=`https://books-backend.p.goit.global/books/category?category=${t}`;try{let t=await eh.get(e);if(200!==t.status)throw Error("Failed to fetch books");return t.data}catch(t){throw console.error("Error fetching books:",t),Error("Failed to fetch books")}}//////////////////////////////////////////////////////////////////////// karty ksiazki po id///////////////////////////////////
...
</li>`;ex.innerHTML+=e}({bookDetails:e})}function ej(t){let e=document.createElement("div");e.classList.add("book-card"),e.innerHTML=`
...
});let n=e.querySelector(".add-to-cart-button"),o=e.querySelector(".add-to-cart-message"),i=JSON.parse(localStorage.getItem("shoppingList"))||[],s=t._id;i.includes(s)&&(n.textContent="remove from list"),n.addEventListener("click",()=>{if(i.includes(s)){let t=i.indexOf(s);i.splice(t,1),n.textContent="add to shopping list",o.textContent="The book has been removed from the shopping list."}else i.push(s),n.textContent="remove from list",o.textContent='Congratulations! You have added the book to the shopping list. To delete, press the button "Remove from the shopping list."';localStorage.setItem("shoppingList",JSON.stringify(i)),console.log("Lista zakup\xf3w w localStorage:",i)});let a=document.getElementById("bookCardContainer");return a.innerHTML="",a.appendChild(e),e}!//funckja do tworzenia całej sekcji shopping list
function(){let t=localStorage.getItem("id"),e=JSON.parse(t);if(0===e.length){let t=document.querySelector(".empty-shopping-list");t.add("visible");return}e.forEach(t=>eN(t))}();var eP={};eP=new URL("support1.26f74ce1.svg",import.meta.url).toString();var eI={};eI=new URL("support2.6d865306.svg",import.meta.url).toString();var eF={};eF=new URL("support3.a3ca15ad.svg",import.meta.url).toString();var eD={};eD=new URL("support4.16605e64.svg",import.meta.url).toString();var eM={};eM=new URL("support5.0237806b.svg",import.meta.url).toString();var eH={};eH=new URL("support6.2b2d4d01.svg",import.meta.url).toString();var eq={};eq=new URL("support7.30f6f4bc.svg",import.meta.url).toString();var ez={};ez=new URL("support8.c13591df.svg",import.meta.url).toString();var e$={};e$=new URL("support9.217f8265.svg",import.meta.url).toString();const eJ=[// ... (fundacje charytatywne)
{title:"Save the Children",url:"https://www.savethechildren.net/what-we-do/emergencies/ukraine-crisis",img:/*@__PURE__*/a(eP)},{title:"Project HOPE",url:"https://www.projecthope.org/country/ukraine/",img:/*@__PURE__*/a(eI)},{title:"UNITED24",url:"https://u24.gov.ua/uk",img:/*@__PURE__*/a(eF)},{title:"International Medical Corps",url:"https://internationalmedicalcorps.org/country/ukraine/",img:/*@__PURE__*/a(eD)},{title:"Medicins Sans Frontieres",url:"https://www.msf.org/ukraine",img:/*@__PURE__*/a(eM)},{title:"RAZOM",url:"https://www.razomforukraine.org/",img:/*@__PURE__*/a(eH)},{title:"Action against hunger",url:"https://www.actionagainsthunger.org/location/europe/ukraine/",img:/*@__PURE__*/a(eq)},{title:"World vision",url:"https://www.wvi.org/emergencies/ukraine",img:/*@__PURE__*/a(ez)},{title:"Serhiy Prytula Charity Foundation",url:"https://prytulafoundation.org/en",img:/*@__PURE__*/a(e$)}],eW=document.getElementById("charitiesSlider");//////////////////////////////////////////////////
// funkcja oblsugi button 'See more'
function eV(t){let e=t.target.closest(".category-button");if(e){let t=e.closest("li"),r=t.querySelector("h2").textContent;ek(r).then(e=>{document.querySelectorAll(".category, .categoryTop, .category-button").forEach(t=>{t.classList.remove("selected-category")}),eY.textContent=r,eG(e,r),// dodana klasa selected-category tylko do klikniętej kategorii
...
function eK(t){let e=document.getElementById("booksList");e.innerHTML="",t.forEach(t=>{let r=document.createElement("ul");e.appendChild(r),t.books.forEach(e=>{let n=document.createElement("li");n.innerHTML=`
        <div>
          <h2>${t.list_name}</h2>          
      ...
      `,r.appendChild(n),n.addEventListener("click",eV),// /////////
//Modal, ten sam kod dodany w 4 miejscach
n.addEventListener("click",async()=>{let t=document.getElementById("bookCardContainer");t.innerHTML="";try{let r=await eB(e._id),n=ej(r);t.appendChild(n)}catch(t){console.error(t)}});// /////////
})})}////////////////////////////
function eG(t,e){let r=document.getElementById("booksList");if(r.innerHTML="",t&&t.length>0)t.forEach(t=>{let e=document.createElement("li");e.innerHTML=`
        <div>             
          <img src="${t.book_image}" alt="${t.title}" />
          <h3>${t.title}</h3>
          <p>Author: ${t.author}</p>
        </div>
      `,e.addEventListener("click",async()=>{let e=document.getElementById("bookCardContainer");e.innerHTML="";try{let r=await eB(t._id),n=ej(r);e.appendChild(n)}catch(t){console.error(t)}}),r.appendChild(e)});else{let t=document.createElement("p");t.textContent="No books found in this category.",r.appendChild(t)}}eJ.forEach(t=>{let e=document.createElement("div");e.innerHTML=`<a href="${t.url}" target="_blank">${t.title}</a>`,eW.appendChild(e)}),eU().then(t=>{//console.log('Categories Received:', categoriesData);
!////////////////////////////
// lista kategorii
...
console.error("Error in promise chain:",t)}),document.getElementById("bestSellers").addEventListener("click",async t=>{if("LI"===t.target.tagName){let e=t.target.textContent;if("Best Sellers Books"===e)try{let t=await e_("best-sellers");document.getElementById("bestSellersHeader").textContent="Best Sellers Books",eK(t,"booksList")}catch(t){console.error("Error fetching best sellers:",t),alert("Failed to fetch best sellers. Please try again.")}else{let t=await e_(e);document.getElementById("bestSellersHeader").textContent=e,eK(t,"booksList")}}}),document.querySelectorAll(".category");const eY=document.getElementById("bestSellersHeader");document.getElementById("categoriesList").addEventListener("click",async t=>{let e=t.target.closest(".category, .categoryTop");if(e){let t=e.textContent,r=await ek(t);// usuwamy klasę selected-category od wszystkich kategorii
document.querySelectorAll(".category, .categoryTop").forEach(t=>{t.classList.remove("selected-category")}),eY.textContent=t,eG(r,t),// dodana  klasa selected-category tylko do klikniętej kategorii
...
});*///# sourceMappingURL=index.37dc1628.js.map
