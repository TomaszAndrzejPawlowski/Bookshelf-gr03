...
function(){let t=localStorage.getItem("shoppingList"),e=JSON.parse(t);if(null===e){let t=document.querySelector(".empty-shopping-list");t.classList.add("visible");return}e.forEach(t=>eN(t))}();var eP={};eP=new URL("1org.11712742.svg",import.meta.url).toString();var eI={};eI=new URL("support2.6d865306.svg",import.meta.url).toString();var eF={};eF=new URL("support3.a3ca15ad.svg",import.meta.url).toString();var eM={};eM=new URL("support4.16605e64.svg",import.meta.url).toString();var eD={};eD=new URL("support5.0237806b.svg",import.meta.url).toString();var eH={};eH=new URL("support6.2b2d4d01.svg",import.meta.url).toString();var eq={};eq=new URL("support7.30f6f4bc.svg",import.meta.url).toString();var ez={};ez=new URL("support8.c13591df.svg",import.meta.url).toString();var e$={};e$=new URL("support9.217f8265.svg",import.meta.url).toString();const eJ=[// ... (fundacje charytatywne)
...
});*///# sourceMappingURL=index.db6562df.js.map
