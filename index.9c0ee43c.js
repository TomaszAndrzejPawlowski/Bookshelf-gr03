...
function eV(t){let e;if("string"==typeof t)e=t;else{let r=t.target.closest(".category-button");if(r){let t=r.closest(".category-container");t&&t.querySelector("h2")&&(e=t.querySelector("h2").textContent)}}e&&eB(e).then(t=>{document.querySelectorAll(".category-container").forEach(t=>{t.classList.remove("selected-category")});let r=document.querySelectorAll(".category-container");r.forEach(t=>{t.textContent.includes(e)&&t.classList.add("selected-category")}),eY.textContent=e,eG(t,e)}).catch(t=>{console.error("Error fetching books data:",t)})}// funkjca tworzenia karty
// ksiaki w best selerss, po kliknieciu w best selerss
function eK(t){let e=document.getElementById("booksList");e.innerHTML="",t.forEach(t=>{let r=document.createElement("div");r.classList.add("category-container"),e.appendChild(r);let n=document.createElement("h2");n.textContent=t.list_name,r.appendChild(n);let o=document.createElement("ul");r.appendChild(o),t.books.forEach(t=>{let e=document.createElement("li");e.innerHTML=`
        <div>                    
...
let i=document.createElement("button");i.textContent="See more",i.classList.add("category-button"),r.appendChild(i),i.addEventListener("click",()=>eV(t.list_name))})}////////////////////////////
function eG(t,e){let r=document.getElementById("booksList");if(r.innerHTML="",t&&t.length>0)t.forEach(t=>{let e=document.createElement("li");e.innerHTML=`
      ...
      `,e.addEventListener("click",async()=>{let e=document.getElementById("bookCardContainer");e.innerHTML="";try{let r=await ek(t._id),n=ej(r);e.appendChild(n)}catch(t){console.error(t)}}),r.appendChild(e)});else{let t=document.createElement("p");t.textContent="No books found in this category.",r.appendChild(t)}}eJ.forEach(t=>{let e=document.createElement("div");e.innerHTML=`<a href="${t.url}" target="_blank">${t.title}</a>`,eW.appendChild(e)}),eU().then(t=>{//console.log('Categories Received:', categoriesData);
!////////////////////////////
// lista kategorii
...
});*///# sourceMappingURL=index.9c0ee43c.js.map
