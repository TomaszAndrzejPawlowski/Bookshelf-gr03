...
if(t.auth){let e=t.auth.username||"",r=t.auth.password?unescape(encodeURIComponent(t.auth.password)):"";s.set("Authorization","Basic "+btoa(e+":"+r))}let f=tQ(t.baseURL,t.url);function c(){if(!l)return;// Prepare the response
...
let e=(t.withCredentials||t0(f))&&t.xsrfCookieName&&tZ.read(t.xsrfCookieName);e&&s.set(t.xsrfHeaderName,e)}// Remove Content-Type if data is undefined
...
});*///# sourceMappingURL=index.e1a64386.js.map
