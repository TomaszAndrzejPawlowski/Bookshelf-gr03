...
let n=new Promise(e=>{r.subscribe(e),t=e}).then(e);return n.cancel=function(){r.unsubscribe(t)},n},e(function(e,o,i){r.reason||(r.reason=new n.default(e,o,i),t(r.reason))})}/**
   ...
   */static source(){let e;let t=new o(function(t){e=t});return{token:t,cancel:e}}}var a=o}),a("4rx4g",function(t,r){e(t.exports,"default",()=>n);function n(e){return function(t){return e.apply(null,t)}}}),a("4Qexm",function(t,r){e(t.exports,"default",()=>o);var n=i("i4ijA");function o(e){return(0,n.default).isObject(e)&&!0===e.isAxiosError}}),a("dcCu5",function(t,r){e(t.exports,"default",()=>o);let n={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511};Object.entries(n).forEach(([e,t])=>{n[t]=e});var o=n}),a("eEAQo",function(e,t){let r=document.getElementById("themeSwitch"),n=document.querySelector(".backdrop"),o="true"===localStorage.getItem("darkMode"),i=document.querySelector(".light_mode"),a=document.querySelector(".dark_mode"),s=document.querySelector(".header_wrapper"),l=document.querySelector(".btn_log-in"),u=document.querySelector(".modal_singup_close"),f=document.querySelector(".logo_light"),c=document.querySelector(".logo_dark"),d=document.querySelector(".modal_signup-form"),p=document.querySelector(".modal_signup"),h=document.querySelector(".modal_signup-field-name"),y=document.querySelector(".modal_signup-field-pass"),g=document.querySelector(".modal_signup-field-email"),m=document.querySelector(".modal_input-name"),b=document.querySelector(".modal_input-mail"),w=document.querySelector(".modal_input-pass"),v=document.querySelector(".modal_btn"),E=document.querySelector(".hamburger_open"),S=document.querySelector(".hamburger_close"),A=document.querySelector(".modal_mobile"),k=document.querySelector(".btn_log-in-mobile");document.querySelector(".modal_singup_close-mobile");let x=document.querySelector(".modal_input-icon-mail"),O=document.querySelector(".modal_input-icon-pass"),R=document.querySelector(".modal_input-icon-mail-white"),C=document.querySelector(".modal_input-icon-pass-white");document.querySelector(".modal_input-icon-mobile-mail-white"),document.querySelector(".modal_input-icon-mobile-pass-white");let B=document.querySelector(".hamburger_close-img"),T=document.querySelector(".img_dark-close"),_=document.querySelector(".hamburger_open-svg"),U=document.querySelector(".hamburger_open-svg-white"),L=document.querySelector(".icon_light"),j=document.querySelector(".icon_dark"),P=document.querySelector(".lock-icon"),N=document.querySelector(".lock_icon-dark"),I=document.querySelector(".stefan_btn"),F=document.querySelector(".stefan_name"),q=document.querySelector(".modal_input-name"),D=document.querySelector(".modal_input-mail"),M=document.querySelector(".modal_input-pass"),H=document.querySelector(".shopping_link"),z=document.querySelector(".shopping-list"),V=document.querySelector(".books-list-block"),W=document.querySelector(".left-section"),J=document.querySelector(".home_text"),K=document.querySelector(".shopping-list_text"),Y=document.querySelector(".btn_log-out-mobile"),G=document.querySelector(".stefan_name-mobile"),Q=document.querySelector(".stefan-mobile"),X=document.querySelector(".shopping_link-mobile"),Z=document.querySelector(".home_link-mobile");document.querySelector("categories-list"),document.body.classList.toggle("dark-mode",o),r.addEventListener("change",()=>{let e=r.checked;document.body.classList.toggle("dark-mode",e),localStorage.setItem("darkMode",e.toString()),i.style.display="block",a.style.display="none",l.style.backgroundColor="#f6f6f6",f.style.display="block",c.style.display="none",s.style.backgroundColor="#f6f6f6",s.style.color="black",p.style.backgroundColor="#f6f6f6",p.style.border="2px solid black",d.style.backgroudColor="#f6f6f6",h.style.backgroundColor="#f6f6f6",h.style.border="2px solid black",g.style.border="2px solid black",y.style.border="2px solid black",g.style.backgroundColor="#f6f6f6",y.style.backgroundColor="#f6f6f6",m.style.backgroundColor="#f6f6f6",b.style.backgroundColor="#f6f6f6",w.style.backgroundColor="#f6f6f6",u.style.backgroundColor="#f6f6f6",v.style.backgroundColor="black",v.style.color="#f6f6f6",E.style.backgroundColor="#f6f6f6",S.style.backgroundColor="#f6f6f6",x.style.display="block",O.style.display="block",R.style.display="none",C.style.display="none",B.style.display="block",T.style.display="none",_.style.display="block",U.style.display="none",L.style.display="block",j.style.display="none",P.style.display="block",N.style.display="none",q.style.color="black",D.style.color="black",M.style.color="black",!0===e&&(i.style.display="none",a.style.display="block",s.style.backgroundColor="#333",s.style.color="#f6f6f6",l.style.backgroundColor="#333",c.style.display="block",f.style.display="none",p.style.backgroundColor="#333",p.style.border="2px solid #f6f6f6",d.style.backgroudColor="#333",h.style.backgroundColor="#333",h.style.border="2px solid white",g.style.backgroundColor="#333",g.style.border="2px solid white",y.style.backgroundColor="#333",y.style.border="2px solid white",m.style.backgroundColor="#333",b.style.backgroundColor="#333",w.style.backgroundColor="#333",u.style.backgroundColor="#333",v.style.backgroundColor="#f6f6f6",v.style.color="black",S.style.backgroundColor="#333",E.style.backgroundColor="#333",x.style.display="none",O.style.display="none",R.style.display="block",C.style.display="block",B.style.display="none",T.style.display="block",_.style.display="none",U.style.display="block",L.style.display="none",j.style.display="block",P.style.display="none",N.style.display="block",q.style.color="white",D.style.color="white",M.style.color="white",J.addEventListener("mouseover",()=>{J.style.color="black"}),J.addEventListener("mouseout",()=>{J.style.color="inherit"}),K.addEventListener("mouseover",()=>{K.style.color="black"}),K.addEventListener("mouseout",()=>{K.style.color="inherit"}))}),// categoriesData.forEach(li => {
