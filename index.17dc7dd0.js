...
M.from=(t,e,r,n,o,i)=>{let s=Object.create($);return H.toFlatObject(t,s,function(t){return t!==Error.prototype},t=>"isAxiosError"!==t),M.call(s,t.message,e,r,n,o),s.cause=t,s.name=t.name,i&&Object.assign(s,i),s},o=function(t){// go through the array every three bytes, we'll deal with trailing stuff later
...
const t$=H.toObjectSet(["age","authorization","content-length","content-type","etag","expires","from","host","if-modified-since","if-unmodified-since","last-modified","location","max-forwards","proxy-authorization","referer","retry-after","user-agent"]);var /**
 ...
 */tq=t=>{let e,r,n;let o={};return t&&t.split("\n").forEach(function(t){n=t.indexOf(":"),e=t.substring(0,n).trim().toLowerCase(),r=t.substring(n+1).trim(),!e||o[e]&&t$[e]||("set-cookie"===e?o[e]?o[e].push(r):o[e]=[r]:o[e]=o[e]?o[e]+", "+r:r)}),o};const tz=Symbol("internals");function tJ(t){return t&&String(t).trim().toLowerCase()}function tW(t){return!1===t||null==t?t:H.isArray(t)?t.map(tW):String(t)}const tV=t=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(t.trim());function tK(t,e,r,n,o){if(H.isFunction(n))return n.call(this,e,r);if(o&&(e=r),H.isString(e)){if(H.isString(n))return -1!==e.indexOf(n);if(H.isRegExp(n))return n.test(e)}}class tG{constructor(t){t&&this.set(t)}set(t,e,r){let n=this;function o(t,e,r){let o=tJ(e);if(!o)throw Error("header name must be a non-empty string");let i=H.findKey(n,o);i&&void 0!==n[i]&&!0!==r&&(void 0!==r||!1===n[i])||(n[i||e]=tW(t))}let i=(t,e)=>H.forEach(t,(t,r)=>o(t,r,e));return H.isPlainObject(t)||t instanceof this.constructor?i(t,e):H.isString(t)&&(t=t.trim())&&!tV(t)?i(tq(t),e):null!=t&&o(e,t,r),this}get(t,e){if(t=tJ(t)){let r=H.findKey(this,t);if(r){let t=this[r];if(!e)return t;if(!0===e)return function(t){let e;let r=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;for(;e=n.exec(t);)r[e[1]]=e[2];return r}(t);if(H.isFunction(e))return e.call(this,t,r);if(H.isRegExp(e))return e.exec(t);throw TypeError("parser must be boolean|regexp|function")}}}has(t,e){if(t=tJ(t)){let r=H.findKey(this,t);return!!(r&&void 0!==this[r]&&(!e||tK(this,this[r],r,e)))}return!1}delete(t,e){let r=this,n=!1;function o(t){if(t=tJ(t)){let o=H.findKey(r,t);o&&(!e||tK(r,r[o],o,e))&&(delete r[o],n=!0)}}return H.isArray(t)?t.forEach(o):o(t),n}clear(t){let e=Object.keys(this),r=e.length,n=!1;for(;r--;){let o=e[r];(!t||tK(this,this[o],o,t,!0))&&(delete this[o],n=!0)}return n}normalize(t){let e=this,r={};return H.forEach(this,(n,o)=>{let i=H.findKey(r,o);if(i){e[i]=tW(n),delete e[o];return}let s=t?o.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(t,e,r)=>e.toUpperCase()+r):String(o).trim();s!==o&&delete e[o],e[s]=tW(n),r[s]=!0}),this}concat(...t){return this.constructor.concat(this,...t)}toJSON(t){let e=Object.create(null);return H.forEach(this,(r,n)=>{null!=r&&!1!==r&&(e[n]=t&&H.isArray(r)?r.join(", "):r)}),e}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([t,e])=>t+": "+e).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(t){return t instanceof this?t:new this(t)}static concat(t,...e){let r=new this(t);return e.forEach(t=>r.set(t)),r}static accessor(t){let e=this[tz]=this[tz]={accessors:{}},r=e.accessors,n=this.prototype;function o(t){let e=tJ(t);r[e]||(!function(t,e){let r=H.toCamelCase(" "+e);["get","set","has"].forEach(n=>{Object.defineProperty(t,n+r,{value:function(t,r,o){return this[n].call(this,e,t,r,o)},configurable:!0})})}(n,t),r[e]=!0)}return H.isArray(t)?t.forEach(o):o(t),this}}function tY(t,e){let r=this||tM,n=e||r,o=tG.from(n.headers),i=n.data;return H.forEach(t,function(t){i=t.call(r,i,o.normalize(),e?e.status:void 0)}),o.normalize(),i}function tX(t){return!!(t&&t.__CANCEL__)}/**
...
</li>`;eI.innerHTML+=r}(r)}),eI.addEventListener("click",eP)}();var eD={};eD=new URL("1org.11712742.svg",import.meta.url).toString();var eH={};eH=new URL("support2.6d865306.svg",import.meta.url).toString();var eM={};eM=new URL("support3.a3ca15ad.svg",import.meta.url).toString();var e$={};e$=new URL("support4.16605e64.svg",import.meta.url).toString();var eq={};eq=new URL("support5.0237806b.svg",import.meta.url).toString();var ez={};ez=new URL("support6.2b2d4d01.svg",import.meta.url).toString();var eJ={};eJ=new URL("support7.30f6f4bc.svg",import.meta.url).toString();var eW={};eW=new URL("support8.c13591df.svg",import.meta.url).toString();var eV={};eV=new URL("support9.217f8265.svg",import.meta.url).toString();const eK=[// ... (fundacje charytatywne)
{title:"",url:"https://www.savethechildren.net/what-we-do/emergencies/ukraine-crisis",img:/*@__PURE__*/e(eD)},{title:"",url:"https://www.projecthope.org/country/ukraine/",img:/*@__PURE__*/e(eH)},{title:"",url:"https://internationalmedicalcorps.org/country/ukraine/",img:/*@__PURE__*/e(eM)},{title:"",url:"https://www.razomforukraine.org/",img:/*@__PURE__*/e(e$)},{title:"",url:"https://www.actionagainsthunger.org/location/europe/ukraine/",img:/*@__PURE__*/e(eq)},{title:"",url:"https://prytulafoundation.org/en",img:/*@__PURE__*/e(ez)},{title:"",url:"https://www.msf.org/ukraine",img:/*@__PURE__*/e(eJ)},{title:"",url:"https://www.wvi.org/emergencies/ukraine",img:/*@__PURE__*/e(eW)},{title:"",url:"https://u24.gov.ua/uk",img:/*@__PURE__*/e(eV)}],eG=document.getElementById("charitiesSlider");for(;eG.firstChild;)eG.removeChild(eG.firstChild);eK.forEach(t=>{let e=document.createElement("a");e.href=t.url,e.target="_blank";let r=document.createElement("div");r.classList.add("charity-item");let n=document.createElement("img");n.src=t.img,n.alt=t.title;let o=document.createElement("div");o.textContent=t.title,o.classList.add("charity-title"),r.appendChild(n),r.appendChild(o),e.appendChild(r),eG.appendChild(e)});//import { handleSeeMoreButtonClick } from './indexCallbacks';
