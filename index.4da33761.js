...
t=tA(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}const tO=D.toFlatObject(D,{},null,function(t){return/^is[A-Z]/.test(t)});var tL=/**
...
const{Axios:ed,AxiosError:ep,CanceledError:em,isCancel:eg,CancelToken:ey,VERSION:eb,all:eE,Cancel:ew,isAxiosError:ev,spread:eC,toFormData:eA,AxiosHeaders:eS,HttpStatusCode:eO,formToJSON:eL,getAdapter:eR,mergeConfig:ek}=eh;async function eT(t){let e=`https://books-backend.p.goit.global/books/category?category=${t}`;try{let t=await eh.get(e);if(200!==t.status)throw Error("Failed to fetch books");return t.data}catch(t){throw console.error("Error fetching books:",t),Error("Failed to fetch books")}}//////////////////////////////////////////////////////////////////////// karty ksiazki po id///////////////////////////////////
...
});*///# sourceMappingURL=index.4da33761.js.map
