...
let i=r?Object.getOwnPropertyNames(t):Object.keys(t),s=i.length;for(n=0;n<s;n++)o=i[n],e.call(null,t[o],o,t)}}}function C(t,e){let r;e=e.toLowerCase();let n=Object.keys(t),o=n.length;for(;o-- >0;)if(e===(r=n[o]).toLowerCase())return r;return null}const B=/*eslint no-undef:0*/"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:s,U=t=>!d(t)&&t!==B,L=(r="undefined"!=typeof Uint8Array&&l(Uint8Array),t=>r&&t instanceof r),k=c("HTMLFormElement"),x=(({hasOwnProperty:t})=>(e,r)=>t.call(e,r))(Object.prototype),j=c("RegExp"),N=(t,e)=>{let r=Object.getOwnPropertyDescriptors(t),n={};T(r,(r,o)=>{let i;!1!==(i=e(r,o,t))&&(n[o]=i||r)}),Object.defineProperties(t,n)},P="abcdefghijklmnopqrstuvwxyz",_="0123456789",I={DIGIT:_,ALPHA:P,ALPHA_DIGIT:P+P.toUpperCase()+_},F=c("AsyncFunction");var D={isArray:p,isArrayBuffer:y,isBuffer:/**
...
)o.push(function(t,e,r){for(var n,o=[],i=e;i<r;i+=3)o.push(H[(n=(t[i]<<16&16711680)+(t[i+1]<<8&65280)+(255&t[i+2]))>>18&63]+H[n>>12&63]+H[n>>6&63]+H[63&n]);return o.join("")}(t,i,i+16383>s?s:i+16383));return 1===n?o.push(H[(e=t[r-1])>>2]+H[e<<4&63]+"=="):2===n&&o.push(H[(e=(t[r-2]<<8)+t[r-1])>>10]+H[e>>4&63]+H[e<<2&63]+"="),o.join("")};for(var H=[],$=[],J="undefined"!=typeof Uint8Array?Uint8Array:Array,V="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",W=0,K=V.length;W<K;++W)H[W]=V[W],$[V.charCodeAt(W)]=W;// Support decoding URL-safe base64 strings, as Node.js does.
// See: https://en.wikipedia.org/wiki/Base64#URL_applications
$["-".charCodeAt(0)]=62,$["_".charCodeAt(0)]=63,o=function(t,e,r,n,o){var i,s,a=8*o-n-1,u=(1<<a)-1,l=u>>1,f=-7,c=r?o-1:0,h=r?-1:1,p=t[e+c];for(c+=h,i=p&(1<<-f)-1,p>>=-f,f+=a;f>0;i=256*i+t[e+c],c+=h,f-=8);for(s=i&(1<<-f)-1,i>>=-f,f+=n;f>0;s=256*s+t[e+c],c+=h,f-=8);if(0===i)i=1-l;else{if(i===u)return s?NaN:(p?-1:1)*(1/0);s+=Math.pow(2,n),i-=l}return(p?-1:1)*s*Math.pow(2,i-n)},i=function(t,e,r,n,o,i){var s,a,u,l=8*i-o-1,f=(1<<l)-1,c=f>>1,h=23===o?5960464477539062e-23:0,p=n?0:i-1,d=n?1:-1,y=e<0||0===e&&1/e<0?1:0;for(isNaN(e=Math.abs(e))||e===1/0?(a=isNaN(e)?1:0,s=f):(s=Math.floor(Math.log(e)/Math.LN2),e*(u=Math.pow(2,-s))<1&&(s--,u*=2),s+c>=1?e+=h/u:e+=h*Math.pow(2,1-c),e*u>=2&&(s++,u/=2),s+c>=f?(a=0,s=f):s+c>=1?(a=(e*u-1)*Math.pow(2,o),s+=c):(a=e*Math.pow(2,c-1)*Math.pow(2,o),s=0));o>=8;t[r+p]=255&a,p+=d,a/=256,o-=8);for(s=s<<o|a,l+=o;l>0;t[r+p]=255&s,p+=d,s/=256,l-=8);t[r+p-d]|=128*y};var G="function"==typeof Symbol&&"function"// eslint-disable-line dot-notation
...
,"function"==typeof Uint8Array.prototype.indexOf)?o?Uint8Array.prototype.indexOf.call(t,e,r):Uint8Array.prototype.lastIndexOf.call(t,e,r):tu(t,[e],r,n,o);throw TypeError("val must be string, number or Buffer")}function tu(t,e,r,n,o){var i,s=1,a=t.length,u=e.length;if(void 0!==n&&("ucs2"===(n=String(n).toLowerCase())||"ucs-2"===n||"utf16le"===n||"utf-16le"===n)){if(t.length<2||e.length<2)return -1;s=2,a/=2,u/=2,r/=2}function l(t,e){return 1===s?t[e]:t.readUInt16BE(e*s)}if(o){var f=-1;for(i=r;i<a;i++)if(l(t,i)===l(e,-1===f?0:i-f)){if(-1===f&&(f=i),i-f+1===u)return f*s}else -1!==f&&(i-=i-f),f=-1}else for(r+u>a&&(r=a-u),i=r;i>=0;i--){for(var c=!0,h=0;h<u;h++)if(l(t,i+h)!==l(e,h)){c=!1;break}if(c)return i}return -1}function tl(t,e,r){r=Math.min(t.length,r);for(var n=[],o=e;o<r;){var i,s,a,u,l=t[o],f=null,c=l>239?4:l>223?3:l>191?2:1;if(o+c<=r)switch(c){case 1:l<128&&(f=l);break;case 2:(192&(i=t[o+1]))==128&&(u=(31&l)<<6|63&i)>127&&(f=u);break;case 3:i=t[o+1],s=t[o+2],(192&i)==128&&(192&s)==128&&(u=(15&l)<<12|(63&i)<<6|63&s)>2047&&(u<55296||u>57343)&&(f=u);break;case 4:i=t[o+1],s=t[o+2],a=t[o+3],(192&i)==128&&(192&s)==128&&(192&a)==128&&(u=(15&l)<<18|(63&i)<<12|(63&s)<<6|63&a)>65535&&u<1114112&&(f=u)}null===f?(// we did not generate a valid codePoint so insert a
...
var r=t.indexOf("=");-1===r&&(r=e);var n=r===e?0:4-r%4;return[r,n]}(t),o=n[0],i=n[1],s=new J((o+i)*3/4-i),a=0,u=i>0?o-4:o;for(r=0;r<u;r+=4)e=$[t.charCodeAt(r)]<<18|$[t.charCodeAt(r+1)]<<12|$[t.charCodeAt(r+2)]<<6|$[t.charCodeAt(r+3)],s[a++]=e>>16&255,s[a++]=e>>8&255,s[a++]=255&e;return 2===i&&(e=$[t.charCodeAt(r)]<<2|$[t.charCodeAt(r+1)]>>4,s[a++]=255&e),1===i&&(e=$[t.charCodeAt(r)]<<10|$[t.charCodeAt(r+1)]<<4|$[t.charCodeAt(r+2)]>>2,s[a++]=e>>8&255,s[a++]=255&e),s}(function(t){// Node converts strings with length < 2 to ''
...
return!D.isUndefined(e[t])});let n=r.metaTokens,o=r.visitor||f,i=r.dots,s=r.indexes,a=r.Blob||"undefined"!=typeof Blob&&Blob,u=a&&D.isSpecCompliantForm(e);if(!D.isFunction(o))throw TypeError("visitor must be a function");function l(t){if(null===t)return"";if(D.isDate(t))return t.toISOString();if(!u&&D.isBlob(t))throw new M("Blob is not supported. Use a Buffer instead.");return D.isArrayBuffer(t)||D.isTypedArray(t)?u&&"function"==typeof Blob?new Blob([t]):Y.from(t):t}/**
   * Default visitor.
   *
   * @param {*} value
   ...
   */function f(t,r,o){let a=t;if(t&&!o&&"object"==typeof t){if(D.endsWith(r,"{}"))// eslint-disable-next-line no-param-reassign
 ...
 *
 * @returns {void}
 */function tC(t,e){this._pairs=[],t&&tR(t,this,e)}const tB=tC.prototype;/**
 ...
 */function tU(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function tL(t,e,r){let n;/*eslint no-param-reassign:0*/if(!e)return t;let o=r&&r.encode||tU,i=r&&r.serialize;if(n=i?i(e,r):D.isURLSearchParams(e)?e.toString():new tC(e,r).toString(o)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+n}return t}tB.append=function(t,e){this._pairs.push([t,e])},tB.toString=function(t){let e=t?function(e){return t.call(this,e,tT)}:tT;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var tk=class{constructor(){this.handlers=[]}/**
   ...
   *
   * @returns {void}
   */forEach(t){D.forEach(this.handlers,function(e){null!==e&&t(e)})}},tx={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},tj="undefined"!=typeof URLSearchParams?URLSearchParams:tC,tN="undefined"!=typeof FormData?FormData:null,tP="undefined"!=typeof Blob?Blob:null;/**
 ...
 *
 * @returns {boolean}
 */const t_=("undefined"==typeof navigator||"ReactNative"!==(t=navigator.product)&&"NativeScript"!==t&&"NS"!==t)&&"undefined"!=typeof window&&"undefined"!=typeof document,tI="undefined"!=typeof WorkerGlobalScope&&// eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var tF={classes:{URLSearchParams:tj,FormData:tN,Blob:tP},isStandardBrowserEnv:t_,isStandardBrowserWebWorkerEnv:tI,protocols:["http","https","file","blob","url","data"]},tD=/**
 ...
 */tz=t=>{let e,r,n;let o={};return t&&t.split("\n").forEach(function(t){n=t.indexOf(":"),e=t.substring(0,n).trim().toLowerCase(),r=t.substring(n+1).trim(),!e||o[e]&&tq[e]||("set-cookie"===e?o[e]?o[e].push(r):o[e]=[r]:o[e]=o[e]?o[e]+", "+r:r)}),o};const tH=Symbol("internals");function t$(t){return t&&String(t).trim().toLowerCase()}function tJ(t){return!1===t||null==t?t:D.isArray(t)?t.map(tJ):String(t)}const tV=t=>/^[-_a-zA-Z0-9^`|~,!#$%&'*+.]+$/.test(t.trim());function tW(t,e,r,n,o){if(D.isFunction(n))return n.call(this,e,r);if(o&&(e=r),D.isString(e)){if(D.isString(n))return -1!==e.indexOf(n);if(D.isRegExp(n))return n.test(e)}}class tK{constructor(t){t&&this.set(t)}set(t,e,r){let n=this;function o(t,e,r){let o=t$(e);if(!o)throw Error("header name must be a non-empty string");let i=D.findKey(n,o);i&&void 0!==n[i]&&!0!==r&&(void 0!==r||!1===n[i])||(n[i||e]=tJ(t))}let i=(t,e)=>D.forEach(t,(t,r)=>o(t,r,e));return D.isPlainObject(t)||t instanceof this.constructor?i(t,e):D.isString(t)&&(t=t.trim())&&!tV(t)?i(tz(t),e):null!=t&&o(e,t,r),this}get(t,e){if(t=t$(t)){let r=D.findKey(this,t);if(r){let t=this[r];if(!e)return t;if(!0===e)return function(t){let e;let r=Object.create(null),n=/([^\s,;=]+)\s*(?:=\s*([^,;]+))?/g;for(;e=n.exec(t);)r[e[1]]=e[2];return r}(t);if(D.isFunction(e))return e.call(this,t,r);if(D.isRegExp(e))return e.exec(t);throw TypeError("parser must be boolean|regexp|function")}}}has(t,e){if(t=t$(t)){let r=D.findKey(this,t);return!!(r&&void 0!==this[r]&&(!e||tW(this,this[r],r,e)))}return!1}delete(t,e){let r=this,n=!1;function o(t){if(t=t$(t)){let o=D.findKey(r,t);o&&(!e||tW(r,r[o],o,e))&&(delete r[o],n=!0)}}return D.isArray(t)?t.forEach(o):o(t),n}clear(t){let e=Object.keys(this),r=e.length,n=!1;for(;r--;){let o=e[r];(!t||tW(this,this[o],o,t,!0))&&(delete this[o],n=!0)}return n}normalize(t){let e=this,r={};return D.forEach(this,(n,o)=>{let i=D.findKey(r,o);if(i){e[i]=tJ(n),delete e[o];return}let s=t?o.trim().toLowerCase().replace(/([a-z\d])(\w*)/g,(t,e,r)=>e.toUpperCase()+r):String(o).trim();s!==o&&delete e[o],e[s]=tJ(n),r[s]=!0}),this}concat(...t){return this.constructor.concat(this,...t)}toJSON(t){let e=Object.create(null);return D.forEach(this,(r,n)=>{null!=r&&!1!==r&&(e[n]=t&&D.isArray(r)?r.join(", "):r)}),e}[Symbol.iterator](){return Object.entries(this.toJSON())[Symbol.iterator]()}toString(){return Object.entries(this.toJSON()).map(([t,e])=>t+": "+e).join("\n")}get[Symbol.toStringTag](){return"AxiosHeaders"}static from(t){return t instanceof this?t:new this(t)}static concat(t,...e){let r=new this(t);return e.forEach(t=>r.set(t)),r}static accessor(t){let e=this[tH]=this[tH]={accessors:{}},r=e.accessors,n=this.prototype;function o(t){let e=t$(t);r[e]||(!function(t,e){let r=D.toCamelCase(" "+e);["get","set","has"].forEach(n=>{Object.defineProperty(t,n+r,{value:function(t,r,o){return this[n].call(this,e,t,r,o)},configurable:!0})})}(n,t),r[e]=!0)}return D.isArray(t)?t.forEach(o):o(t),this}}function tG(t,e){let r=this||tM,n=e||r,o=tK.from(n.headers),i=n.data;return D.forEach(t,function(t){i=t.call(r,i,o.normalize(),e?e.status:void 0)}),o.normalize(),i}function tX(t){return!!(t&&t.__CANCEL__)}/**
...
return{get:()=>t,set(t){this[r]=t}}}),D.freezeMethods(tK),D.inherits(tY,M,{__CANCEL__:!0});var tQ=tF.isStandardBrowserEnv?{write:function(t,e,r,n,o,i){let s=[];s.push(t+"="+encodeURIComponent(e)),D.isNumber(r)&&s.push("expires="+new Date(r).toGMTString()),D.isString(n)&&s.push("path="+n),D.isString(o)&&s.push("domain="+o),!0===i&&s.push("secure"),document.cookie=s.join("; ")},read:function(t){let e=document.cookie.match(RegExp("(^|;\\s*)("+t+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove:function(t){this.write(t,"",Date.now()-864e5)}}:{write:function(){},read:function(){return null},remove:function(){}};function tZ(t,e){return t&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(e)?e?t.replace(/\/+$/,"")+"/"+e.replace(/^\/+/,""):t:e}var t0=tF.isStandardBrowserEnv?// whether the request URL is of the same origin as current location.
...
l.ontimeout=function(){let e=t.timeout?"timeout of "+t.timeout+"ms exceeded":"timeout exceeded",n=t.transitional||tx;t.timeoutErrorMessage&&(e=t.timeoutErrorMessage),r(new M(e,n.clarifyTimeoutError?M.ETIMEDOUT:M.ECONNABORTED,t,l)),// Clean up request
l=null},tF.isStandardBrowserEnv){// Add xsrf header
let e=(t.withCredentials||t0(f))&&t.xsrfCookieName&&tQ.read(t.xsrfCookieName);e&&s.set(t.xsrfHeaderName,e)}// Remove Content-Type if data is undefined
void 0===i&&s.setContentType(null),"setRequestHeader"in l&&D.forEach(s.toJSON(),function(t,e){l.setRequestHeader(e,t)}),D.isUndefined(t.withCredentials)||(l.withCredentials=!!t.withCredentials),a&&"json"!==a&&(l.responseType=t.responseType),"function"==typeof t.onDownloadProgress&&l.addEventListener("progress",t2(t.onDownloadProgress,!0)),"function"==typeof t.onUploadProgress&&l.upload&&l.upload.addEventListener("progress",t2(t.onUploadProgress)),(t.cancelToken||t.signal)&&(// Handle cancellation
// eslint-disable-next-line func-names
n=e=>{l&&(r(!e||e.type?new tY(null,t,l):e),l.abort(),l=null)},t.cancelToken&&t.cancelToken.subscribe(n),t.signal&&(t.signal.aborted?n():t.signal.addEventListener("abort",n)));let h=function(t){let e=/^([-+\w]{1,25})(:?\/\/|:)/.exec(t);return e&&e[1]||""}(f);if(h&&-1===tF.protocols.indexOf(h)){r(new M("Unsupported protocol "+h+":",M.ERR_BAD_REQUEST,t));return}// Send the request
l.send(i||null)})};const t8={http:null,xhr:t5};D.forEach(t8,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
 ...
 */class eu{constructor(t){this.defaults=t,this.interceptors={request:new tk,response:new tk}}/**
   * Dispatch a request
   *
...
let u=[],l=!0;this.interceptors.request.forEach(function(t){("function"!=typeof t.runWhen||!1!==t.runWhen(e))&&(l=l&&t.synchronous,u.unshift(t.fulfilled,t.rejected))});let f=[];this.interceptors.response.forEach(function(t){f.push(t.fulfilled,t.rejected)});let c=0;if(!l){let t=[et.bind(this),void 0];for(t.unshift.apply(t,u),t.push.apply(t,f),n=t.length,r=Promise.resolve(e);c<n;)r=r.then(t[c++],t[c++]);return r}n=u.length;let h=e;for(c=0;c<n;){let t=u[c++],e=u[c++];try{h=t(h)}catch(t){e.call(this,t);break}}try{r=et.call(this,h)}catch(t){return Promise.reject(t)}for(c=0,n=f.length;c<n;)r=r.then(f[c++],f[c++]);return r}getUri(t){t=er(this.defaults,t);let e=tZ(t.baseURL,t.url);return tL(e,t.params,t.paramsSerializer)}}D.forEach(["delete","get","head","options"],function(t){/*eslint func-names:0*/eu.prototype[t]=function(e,r){return this.request(er(r||{},{method:t,url:e,data:(r||{}).data}))}}),D.forEach(["post","put","patch"],function(t){/*eslint func-names:0*/function e(e){return function(r,n,o){return this.request(er(o||{},{method:t,headers:e?{"Content-Type":"multipart/form-data"}:{},url:r,data:n}))}}eu.prototype[t]=e(),eu.prototype[t+"Form"]=e(!0)});/**
 * A `CancelToken` is an object that can be used to request cancellation of an operation.
 *
 * @param {Function} executor The executor function.
 *
 * @returns {CancelToken}
 */class el{constructor(t){let e;if("function"!=typeof t)throw TypeError("executor must be a function.");this.promise=new Promise(function(t){e=t});let r=this;// eslint-disable-next-line func-names
...
ec.CanceledError=tY,ec.CancelToken=el,ec.isCancel=tX,ec.VERSION=en,ec.toFormData=tR,// Expose AxiosError class
...
ec.mergeConfig=er,ec.AxiosHeaders=tK,ec.formToJSON=t=>tD(D.isHTMLForm(t)?new FormData(t):t),ec.getAdapter=t7.getAdapter,ec.HttpStatusCode=ef,ec.default=ec;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
const{Axios:eh,AxiosError:ep,CanceledError:ed,isCancel:ey,CancelToken:eg,VERSION:em,all:eb,Cancel:eE,isAxiosError:ew,spread:ev,toFormData:eA,AxiosHeaders:eO,HttpStatusCode:eS,formToJSON:eR,getAdapter:eT,mergeConfig:eC}=ec;async function eB(t){let e=`https://books-backend.p.goit.global/books/category?category=${t}`;try{let t=await ec.get(e);if(200!==t.status)throw Error("Failed to fetch books");return t.data}catch(t){throw console.error("Error fetching books:",t),Error("Failed to fetch books")}}//////////////////////////////////////////////////////////////////////// karty ksiazki po id///////////////////////////////////
async function eU(t){let e=`https://books-backend.p.goit.global/books/${t}`;try{let t=await ec.get(e);if(200!==t.status)throw Error("Failed to fetch book details");let r=t.data;//console.log(bookDetails);
return r}catch(t){// można obsługę błędu - np. wyświetlenie komunikatu dla użytkownika
throw console.error("Error fetching book details:",t),Error("Failed to fetch book details")}}async function eL(){try{let t=await ec.get("https://books-backend.p.goit.global/books/category-list");return t.data}catch(t){throw console.error("Error fetching categories:",t),Error("Failed to fetch categories")}}async function ek(t){try{let t=await ec.get("https://books-backend.p.goit.global/books/top-books");if(200!==t.status)throw Error("Failed to fetch books");return t.data}catch(t){throw console.error("Error fetching books:",t),Error("Failed to fetch books")}}//import { handleSeeMoreButtonClick } from './indexCallbacks';
//export { fetchBooksData, renderBooks };
const ex=document.getElementById("charitiesSlider");//////////////////////////////////////////////////
// funkcja oblsugi button 'See more'
function ej(t){let e=t.target.closest(".category-button");if(e){let t=e.closest("li"),r=t.querySelector("h2").textContent;eB(r).then(e=>{document.querySelectorAll(".category, .categoryTop, .category-button").forEach(t=>{t.classList.remove("selected-category")}),e_.textContent=r,eP(e,r),// dodana klasa selected-category tylko do klikniętej kategorii
t.classList.add("selected-category")}).catch(t=>{console.error("Error fetching books data:",t)})}}//////////////////////////////////////
// ksiaki w best selerss, po kliknieciu w best selerss
function eN(t){let e=document.getElementById("booksList");e.innerHTML="",t.forEach(t=>{let r=document.createElement("ul");e.appendChild(r),t.books.forEach(e=>{let n=document.createElement("li");n.innerHTML=`
        <div>
          <h2>${t.list_name}</h2>          
...
function eP(t,e){let r=document.getElementById("booksList");if(r.innerHTML="",t&&t.length>0)t.forEach(t=>{let e=document.createElement("li");e.innerHTML=`
        <div>             
          <img src="${t.book_image}" alt="${t.title}" />
          <h3>${t.title}</h3>
          <p>Author: ${t.author}</p>
        </div>
      `,e.addEventListener("click",async()=>{let e=document.getElementById("bookCardContainer");e.innerHTML="";try{let r=await eU(t._id),n=document.createElement("div");n.classList.add("book-card"),n.innerHTML=`<div class="modal-card-container">
          <div class="book-card">
            ...
            <p>Amazon Product URL: <a href="${r.amazon_product_url}" target="_blank">${r.amazon_product_url}</a></p>
            <ul>
              ${r.buy_links.map(t=>`<li><a href="${t.url}" target="_blank">${t.name}</a></li>`).join("")}
            </ul>
            <button class="add-to-cart-button" data-book-id="${r._id}">Add to Cart</button>
            </div></div>
          `;let o=n.querySelector(".close-button");o.addEventListener("click",()=>{e.innerHTML="";// Close the modal
});let i=n.querySelector(".add-to-cart-button");i.addEventListener("click",()=>{console.log("Book added/removed from the cart!")}),e.appendChild(n)}catch(t){console.error(t)}}),r.appendChild(e)});else{let t=document.createElement("p");t.textContent="No books found in this category.",r.appendChild(t)}}// fundacje charytatywne
charities.forEach(t=>{let e=document.createElement("div");e.innerHTML=`<a href="${t.url}" target="_blank">${t.title}</a>`,ex.appendChild(e)}),eL().then(t=>{//console.log('Categories Received:', categoriesData);
!////////////////////////////
// lista kategorii
...
console.error("Error in promise chain:",t)}),ek("some-category").then(t=>{let e=document.getElementById("booksList");t.forEach(t=>{let r=document.createElement("ul");e.appendChild(r);// Utwórz jeden przycisk "See more" dla całego zestawu książek
let n=document.createElement("button");n.className="category-button",n.innerText="See more";// Utwórz jedną sekcję z napisem <h2>${category.list_name}</h2> dla całego zestawu książek
let o=document.createElement("h2");o.innerHTML=t.list_name,r.appendChild(o),t.books.forEach(t=>{let e=document.createElement("li");e.innerHTML=`
          <div>
            <img src="${t.book_image}" alt="${t.title}" />
            <h3>${t.title}</h3>
            <p>Author: ${t.author}</p>
          </div>
        `,r.appendChild(e)}),// Dodaj przycisk "See more" dla całego zestawu książek
r.appendChild(n)})}).catch(t=>{// Obsługa błędów
console.error("Error in promise chain:",t)}),document.getElementById("bestSellers").addEventListener("click",async t=>{if("LI"===t.target.tagName){let e=t.target.textContent;if("Best Sellers Books"===e)try{let t=await ek("best-sellers");document.getElementById("bestSellersHeader").textContent="Best Sellers Books",eN(t,"booksList")}catch(t){console.error("Error fetching best sellers:",t),alert("Failed to fetch best sellers. Please try again.")}else{let t=await ek(e);document.getElementById("bestSellersHeader").textContent=e,eN(t,"booksList")}}}),document.querySelectorAll(".category");const e_=document.getElementById("bestSellersHeader");document.getElementById("categoriesList").addEventListener("click",async t=>{let e=t.target.closest(".category, .categoryTop");if(e){let t=e.textContent,r=await eB(t);// usuwamy klasę selected-category od wszystkich kategorii
document.querySelectorAll(".category, .categoryTop").forEach(t=>{t.classList.remove("selected-category")}),e_.textContent=t,eP(r,t),// dodana  klasa selected-category tylko do klikniętej kategorii
...
});*///# sourceMappingURL=index.5c17134b.js.map
