 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&m(t.buffer)},isString:y,isNumber:E,isBoolean:t=>!0===t||!1===t,isObject:w,isPlainObject:v,isUndefined:g,isDate:A,isFile:C,isBlob:S,isRegExp:N,isFunction:b,isStream:t=>w(t)&&b(t.pipe),isURLSearchParams:L,isTypedArray:U,isFileList:O,forEach:R,merge:/**
 ...
 *
 * @returns {boolean}
 */function(t){return!!(t&&b(t.append)&&"FormData"===t[Symbol.toStringTag]&&t[Symbol.iterator])},toJSONObject:t=>{let e=Array(10),r=(t,n)=>{if(w(t)){if(e.indexOf(t)>=0)return;if(!("toJSON"in t)){e[n]=t;let o=d(t)?[]:{};return R(t,(t,e)=>{let i=r(t,n+1);g(i)||(o[e]=i)}),e[n]=void 0,o}}return t};return r(t,0)},isAsyncFn:M,isThenable:t=>t&&(w(t)||b(t))&&b(t.then)&&b(t.catch)};/**
...
H.from=(t,e,r,n,o,i)=>{let s=Object.create(q);return D.toFlatObject(t,s,function(t){return t!==Error.prototype},t=>"isAxiosError"!==t),H.call(s,t.message,e,r,n,o),s.cause=t,s.name=t.name,i&&Object.assign(s,i),s},n=function(t){// go through the array every three bytes, we'll deal with trailing stuff later
 ...
 *
 * @returns {boolean}
 */function tA(t){return D.isPlainObject(t)||D.isArray(t)}/**
 * It removes the brackets from the end of a string
 *
 * @param {string} key - The key of the parameter.
 *
 * @returns {string} the key without the brackets.
 */function tC(t){return D.endsWith(t,"[]")?t.slice(0,-2):t}/**
...
t=tC(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}const tO=D.toFlatObject(D,{},null,function(t){return/^is[A-Z]/.test(t)});var tL=/**
 ...
 *
 * @returns {void}
 */function tk(t,e){this._pairs=[],t&&tL(t,this,e)}const tT=tk.prototype;/**
...
const{Axios:ep,AxiosError:ed,CanceledError:eg,isCancel:em,CancelToken:ey,VERSION:eb,all:eE,Cancel:ew,isAxiosError:ev,spread:eA,toFormData:eC,AxiosHeaders:eS,HttpStatusCode:eO,formToJSON:eL,getAdapter:eR,mergeConfig:ek}=eh;async function eT(t){let e=`https://books-backend.p.goit.global/books/category?category=${t}`;try{let t=await eh.get(e);if(200!==t.status)throw Error("Failed to fetch books");return t.data}catch(t){throw console.error("Error fetching books:",t),Error("Failed to fetch books")}}//////////////////////////////////////////////////////////////////////// karty ksiazki po id///////////////////////////////////
...
<img width="32" height:"11" src="./images/amazon.png" />
</a>  
<a href=${t.buy_links[1].url}>
<img src="./images/book.png" width="16" height="16"  target="_blank" rel="noopener noreferrer nofollow"/>
</a>  
</div>
</div>
</div>
</li>`;ex.innerHTML+=e}({bookDetails:e})}// console.log(buttonToRemove);
// () => {
...
// creatSchoppingList();
//   localStorage.setItem('shoppingList', JSON.stringify(shoppingList));
function ej(t){let e=document.createElement("div");e.classList.add("book-card"),e.innerHTML=`
...
function(){let t=localStorage.getItem("shoppingList"),e=JSON.parse(t);if(0===e.length){let t=document.querySelector(".empty-shopping-list");t.classList.add("visible");return}e.forEach(t=>eN(t))}();var eP={};eP=new URL("1org.11712742.svg",import.meta.url).toString();var eI={};eI=new URL("support2.6d865306.svg",import.meta.url).toString();var eF={};eF=new URL("support3.a3ca15ad.svg",import.meta.url).toString();var eM={};eM=new URL("support4.16605e64.svg",import.meta.url).toString();var eD={};eD=new URL("support5.0237806b.svg",import.meta.url).toString();var eH={};eH=new URL("support6.2b2d4d01.svg",import.meta.url).toString();var eq={};eq=new URL("support7.30f6f4bc.svg",import.meta.url).toString();var ez={};ez=new URL("support8.c13591df.svg",import.meta.url).toString();var e$={};e$=new URL("support9.217f8265.svg",import.meta.url).toString();const eJ=[// ... (fundacje charytatywne)
{title:"",url:"https://www.savethechildren.net/what-we-do/emergencies/ukraine-crisis",img:/*@__PURE__*/a(eP)},{title:"",url:"https://www.projecthope.org/country/ukraine/",img:/*@__PURE__*/a(eI)},{title:"",url:"https://internationalmedicalcorps.org/country/ukraine/",img:/*@__PURE__*/a(eF)},{title:"",url:"https://www.razomforukraine.org/",img:/*@__PURE__*/a(eM)},{title:"",url:"https://www.actionagainsthunger.org/location/europe/ukraine/",img:/*@__PURE__*/a(eD)},{title:"",url:"https://prytulafoundation.org/en",img:/*@__PURE__*/a(eH)},{title:"",url:"https://www.msf.org/ukraine",img:/*@__PURE__*/a(eq)},{title:"",url:"https://www.wvi.org/emergencies/ukraine",img:/*@__PURE__*/a(ez)},{title:"",url:"https://u24.gov.ua/uk",img:/*@__PURE__*/a(e$)}],eW=document.getElementById("charitiesSlider");for(;eW.firstChild;)eW.removeChild(eW.firstChild);eJ.forEach(t=>{let e=document.createElement("a");e.href=t.url,e.target="_blank";let r=document.createElement("div");r.classList.add("charity-item");let n=document.createElement("img");n.src=t.img,n.alt=t.title;let o=document.createElement("div");o.textContent=t.title,o.classList.add("charity-title"),r.appendChild(n),r.appendChild(o),e.appendChild(r),eW.appendChild(e)});//import { handleSeeMoreButtonClick } from './indexCallbacks';
//export { fetchBooksData, renderBooks };
const eV=document.getElementById("charitiesSlider");//////////////////////////////////////////////////
// funkcja oblsugi button 'See more'
function eK(t){let e;if("string"==typeof t)e=t;else{let r=t.target.closest(".category-button");if(r){let t=r.closest(".category-container");t&&t.querySelector("h2")&&(e=t.querySelector("h2").textContent)}}e&&eT(e).then(t=>{document.querySelectorAll(".category-container").forEach(t=>{t.classList.remove("selected-category")});let r=document.querySelectorAll(".category-container");r.forEach(t=>{t.textContent.includes(e)&&t.classList.add("selected-category")}),eX.textContent=e,eY(t,e)}).catch(t=>{console.error("Error fetching books data:",t)})}// funkjca tworzenia karty
...
});*///# sourceMappingURL=index.d555b493.js.map
