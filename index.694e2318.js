...
function f(e,t){let o=document.getElementById("booksList");if(o.innerHTML="",e&&e.length>0)e.forEach(e=>{let t=document.createElement("li");t.className="list-container",t.innerHTML=`
      ...
      `,t.addEventListener("click",async()=>{let t=document.getElementById("bookCardContainer");t.innerHTML="",g.classList.remove("is-hidden");try{let o=await (0,u.fetchBookDetails)(e._id),n=h(o);t.appendChild(n),g.classList.add("is-hidden")}catch(e){console.error(e),g.classList.add("is-hidden")}}),o.appendChild(t)});else{g.classList.remove("is-hidden");let e=document.createElement("p");e.textContent="No books found in this category.",o.appendChild(e)}"All categories"===t?o.classList.replace("books_category-list","books-list"):o.classList.replace("books-list","books_category-list")}(0,u.fetchCategories)().then(e=>{//console.log('Categories Received:', categoriesData);
// lista kategorii
...
(0,u.fetchBooks)().then(e=>{let t=document.getElementById("booksList");e.forEach(e=>{// tworzy sekcję dla danej kategorii
...
console.error("Error in promise chain:",e)}),document.getElementById("bestSellers").addEventListener("click",async e=>{if("LI"===e.target.tagName&&"All categories"===e.target.textContent)try{//loadingTxt.classList.remove('is-hidden');
let e=await (0,u.fetchBooks)();document.getElementById("bestSellersHeader").innerHTML=`
          Best Sellers <span class="blue-text">Books</span>
          
        `,// funkjca tworzenia karty
// ksiaki w best selerss, po kliknieciu w best selerss
function(e){g.classList.add("is-hidden");let t=document.getElementById("booksList");t.innerHTML="",e.forEach(e=>{let o=document.createElement("div");o.classList.add("category-section"),t.appendChild(o);let n=document.createElement("h2");n.textContent=e.list_name,n.classList.add("category-title"),o.appendChild(n);let a=document.createElement("ul");a.classList.add("category-list"),o.appendChild(a),e.books.forEach(e=>{let t=document.createElement("li");t.classList.add("book-item"),t.innerHTML=`
        <div class="image-container">                    
         ...
         `,a.appendChild(t),// /////////
//Modal, ten sam kod dodany w 4 miejscach
t.addEventListener("click",async()=>{g.classList.remove("is-hidden");let t=document.getElementById("bookCardContainer");t.innerHTML="";try{let o=await (0,u.fetchBookDetails)(e._id),n=h(o);t.appendChild(n),g.classList.add("is-hidden")}catch(e){console.error(e)}});// /////////
});// Przycisk "See more" dodany raz dla całej kategorii, na końcu zestawu książek
let i=document.createElement("button");i.textContent="See more",i.classList.add("category-button"),o.appendChild(i),i.addEventListener("click",()=>m(e.list_name))})}(e)}catch(e){console.error("Error fetching best sellers:",e),alert("Failed to fetch best sellers. Please try again.")}}),document.querySelectorAll(".category");const b=document.getElementById("bestSellersHeader");document.getElementById("categoriesList").addEventListener("click",async e=>{let t=e.target.closest(".category, .categoryTop");if(g.classList.remove("is-hidden"),t){let e=t.textContent,o=await (0,u.fetchBooksData)(e),n=function(e){let t=e.split(" ");return t[t.length-1]}(e);g.classList.add("is-hidden"),// Usuwa klasę selected-category od wszystkich elementów o klasie 'category' lub 'categoryTop'
...
//   }
// });
//# sourceMappingURL=index.694e2318.js.map
