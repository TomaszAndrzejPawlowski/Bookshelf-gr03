function e(e){return e&&e.__esModule?e.default:e}var t=globalThis,o={},n={},a=t.parcelRequire8f04;null==a&&((a=function(e){if(e in o)return o[e].exports;if(e in n){var t=n[e];delete n[e];var a={id:e,exports:{}};return o[e]=a,t.call(a.exports,a,a.exports),a.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,t){n[e]=t},t.parcelRequire8f04=a);var i=a.register;i("ifJdc",function(e,t){Object.defineProperty(e.exports,"register",{get:()=>o,set:e=>o=e,enumerable:!0,configurable:!0});var o,n=new Map;o=function(e,t){for(var o=0;o<t.length-1;o+=2)n.set(t[o],{baseUrl:e,path:t[o+1]})}}),i("D20OV",function(e,t){e.exports=new URL("apple.eccc0cef.svg",import.meta.url).toString()}),i("3dS40",function(e,t){e.exports=new URL("amazon.3527c8ee.svg",import.meta.url).toString()}),a("ifJdc").register(new URL("",import.meta.url).toString(),JSON.parse('["eFRlh","index.195d2571.js","5h1Oy","apple.eccc0cef.svg","d6HPj","amazon.3527c8ee.svg","dadY1","barnesandnoble_logo.5e32b091.svg","hZXVu","booksamillion_logo.fcbc7356.svg","5tQdo","bookshop.f310b8df.png","d5QCj","indiebound_logo.207267c0.svg","bSbOs","shoppingList.9b2b820c.css","6IVcl","shoppingList.097dcf65.js","cDgZQ","shoppingList.runtime.65078295.js"]')),a("7Abz9"),a("eEAQo"),a("3XIIJ"),a("lUzRb"),a("865h4");var l=a("D20OV"),s=a("3dS40"),r={};r=new URL("barnesandnoble_logo.5e32b091.svg",import.meta.url).toString();var c={};c=new URL("booksamillion_logo.fcbc7356.svg",import.meta.url).toString();var d={};d=new URL("bookshop.f310b8df.png",import.meta.url).toString();var p={};function u(t){let o=document.createElement("div");o.classList.add("book-card"),o.innerHTML=`
  ...
  `;let n=o.querySelector(".popup-close-button");n.addEventListener("click",()=>{let e=document.getElementById("bookCardContainer");e.innerHTML=""});let a=o.querySelector(".add-to-cart-button"),i=o.querySelector(".add-to-cart-message"),u=JSON.parse(localStorage.getItem("shoppingList"))||[],h=t._id;u.includes(h)&&(a.textContent="remove from list"),a.addEventListener("click",()=>{if(u.includes(h)){let e=u.indexOf(h);u.splice(e,1),a.textContent="add to shopping list",i.textContent="The book has been removed from the shopping list."}else u.push(h),a.textContent="remove from list",i.textContent='Congratulations! You have added the book to the shopping list. To delete, press the button "Remove from the shopping list."';localStorage.setItem("shoppingList",JSON.stringify(u)),console.log("Lista zakup\xf3w w localStorage:",u)});let g=document.getElementById("bookCardContainer");return g.innerHTML="",g.appendChild(o),document.addEventListener("keydown",function(e){if("Escape"===e.key){let e=document.getElementById("bookCardContainer");e.innerHTML=""}}),document.addEventListener("click",function(e){if(e.target.classList.contains("popup-card-container")){let e=document.getElementById("bookCardContainer");e.innerHTML=""}}),o}p=new URL("indiebound_logo.207267c0.svg",import.meta.url).toString();var h=a("7Abz9");const g=document.querySelector(".loader");//   loadingTxt.classList.add('is-hidden');
// });
//////////////////////////////////////////////////
...
function b(e,t){let o=document.getElementById("booksList");if(o.innerHTML="",e&&e.length>0)e.forEach(e=>{let t=document.createElement("li");t.className="list-container",t.innerHTML=`
      ...
      `,t.addEventListener("click",async()=>{let t=document.getElementById("bookCardContainer");t.innerHTML="",g.classList.remove("is-hidden");try{let o=await (0,h.fetchBookDetails)(e._id),n=u(o);t.appendChild(n),g.classList.add("is-hidden")}catch(e){console.error(e),g.classList.add("is-hidden")}}),o.appendChild(t)});else{let e=document.createElement("p");e.textContent="No books found in this category.",o.appendChild(e)}"All categories"===t?o.classList.replace("books_category-list","books-list"):o.classList.replace("books-list","books_category-list")}(0,h.fetchCategories)().then(e=>{//console.log('Categories Received:', categoriesData);
// lista kategorii
...
//   }
// });
//# sourceMappingURL=index.195d2571.js.map
