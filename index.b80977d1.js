 ...
 *
 * @returns {void}
 */function tR(t,e){this._pairs=[],t&&tO(t,this,e)}const tL=tR.prototype;/**
 ...
 */function tB(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function tk(t,e,r){let n;/*eslint no-param-reassign:0*/if(!e)return t;let o=r&&r.encode||tB,i=r&&r.serialize;if(n=i?i(e,r):D.isURLSearchParams(e)?e.toString():new tR(e,r).toString(o)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+n}return t}tL.append=function(t,e){this._pairs.push([t,e])},tL.toString=function(t){let e=t?function(e){return t.call(this,e,tT)}:tT;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var tU=class{constructor(){this.handlers=[]}/**
...
const{Axios:eh,AxiosError:ep,CanceledError:ed,isCancel:eg,CancelToken:em,VERSION:ey,all:eb,Cancel:eE,isAxiosError:ew,spread:ev,toFormData:eA,AxiosHeaders:eC,HttpStatusCode:eS,formToJSON:eO,getAdapter:eT,mergeConfig:eR}=ef;async function eL(t){let e=`https://books-backend.p.goit.global/books/category?category=${t}`;try{let t=await ef.get(e);if(200!==t.status)throw Error("Failed to fetch books");return t.data}catch(t){throw console.error("Error fetching books:",t),Error("Failed to fetch books")}}//////////////////////////////////////////////////////////////////////// karty ksiazki po id///////////////////////////////////
async function eB(t){let e=`https://books-backend.p.goit.global/books/${t}`;try{let t=await ef.get(e);if(200!==t.status)throw Error("Failed to fetch book details");let r=t.data;//console.log(bookDetails);
...
async function e_(t){let e=await eB(t);!// tworzy pojedynczy element li
...
n.addEventListener("click",async()=>{let t=document.getElementById("bookCardContainer");t.innerHTML="";try{let r=await eB(e._id),n=eN(r);t.appendChild(n)}catch(t){console.error(t)}});// /////////
})})}////////////////////////////
function eF(t,e){let r=document.getElementById("booksList");if(r.innerHTML="",t&&t.length>0)t.forEach(t=>{let e=document.createElement("li");e.innerHTML=`
      ...
      `,e.addEventListener("click",async()=>{let e=document.getElementById("bookCardContainer");e.innerHTML="";try{let r=await eB(t._id),n=eN(r);e.appendChild(n)}catch(t){console.error(t)}}),r.appendChild(e)});else{let t=document.createElement("p");t.textContent="No books found in this category.",r.appendChild(t)}}[// ... (fundacje charytatywne)
...
//Modal, ten sam kod dodany w 4 miejscach
e.addEventListener("click",async()=>{let e=document.getElementById("bookCardContainer");e.innerHTML="";try{let r=await eB(t._id),n=eN(r);e.appendChild(n)}catch(t){console.error(t)}});// /////////
...
});*///# sourceMappingURL=index.b80977d1.js.map
